...
module.exports = function (app, db, version) {
   ...
   */
    ...
    app.get('/v1/local_areas/:country_code', function (req, res) {
   ...
   */
    ...
    app.get("/v1/clusters", get_clusters_fn);
   ...
   */
    ...
    app.get("/v1/clusters/shapefile", shapefile_clusters_fn);


    app.get("/v1/clusters/all", curry(all_clusters)(DB));

    app.get("/v1/clusters/_regenerate", curry(regenerate_clusters)(DB));
   ...
   */
   ...
   app.get("/v1/clusters/count", count_clusters_fn);
   ...
   */
    ...
    app.post("/v1/clusters", post_clusters_fn);
   ...
   */
    ...
    app.put("/v1/clusters", put_clusters_fn);
   ...
   */
    ...
    app.delete("/v1/clusters", delete_clusters_fn);
   ...
   */
    ...
    app.get("/v1/tasks/count", (req, res) => {
   ...
   */
    app.get("/v1/spatial_entities", (req, res) => {
 ...
 */
    ...
    app.post("/v1/spatial_entities", (req, res) => {
   ...
   */
    app.get("/v1/spatial_entity_points", (req, res) => {
 ...
 */
    ...
    app.post("/v1/spatial_entity_points", (req, res) => {
