...
const case_location = require('./routes/foci/case')
...
module.exports = function (app, version) {
    ...
    addPermission('get', '/foci/cluster', ['read:foci'])
    addPermission('post','/foci/cluster',['write:foci'])
    addPermission('put','/foci/cluster',['write:foci'])
    addPermission('delete','/foci/cluster',['write:foci'])
    addPermission('get','/foci/number_of_clusters',['read:foci'])
    app.get(v('/foci/number_of_clusters'),cluster.count)
    app.post(v('/foci/cluster'), cluster.create)
    app.get(v('/foci/cluster'), cluster.get_all)
    app.put(v('/foci/cluster'), cluster.update)
    app.delete(v('/foci/cluster'), cluster.delete_cluster)
    ...
    app.get(v('/foci/number_of_cases'),case_location.count)
    app.post(v('/foci/case'), case_location.create)
    app.post(v('/foci/case/bulk'), case_location.create_bulk)
    app.get(v('/foci/case'), case_location.get_all)
    app.put(v('/foci/case'), case_location.update)
    app.delete(v('/foci/case'), case_location.delete_case_point)
