...
test.skip('GET /v4/plan/current without api token => 401', async t => {
    t.plan(2)
...
test.skip('GET /v4/plan/current with wrong api token => 401', async t => {
    t.plan(2)
...
test.skip('GET /v4/plan/current with correct api token and no permissions => 401', async t => {
    t.plan(1)
...
test.skip('GET /v4/plan/current with correct api token and sufficient permissions => 200', async t => {
    t.plan(1)
